...
export default function Home() {
  return (
    <main className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      <a
        href="#content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:rounded-lg focus:bg-white focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-slate-900 dark:focus:bg-slate-800 dark:focus:text-slate-100"
      >
        Skip to content
      </a>
          ...
          <div className="resume-pad">
            ...
            <header className="mb-12 text-center animate-fade-in">
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-700 dark:from-blue-400 dark:via-cyan-400 dark:to-blue-500 bg-clip-text text-transparent animate-fade-in tracking-tight">
                ...
                <span className="font-mono text-4xl md:text-5xl font-medium">"HARKA LOPCHAN"</span>
              </h1>
              ...
              <p className="text-base md:text-xl text-slate-700 dark:text-slate-300 mb-8 font-light max-w-3xl mx-auto leading-relaxed">
                Open to <strong className="text-blue-600 dark:text-blue-400">Senior Frontend / Lead Frontend roles — UAE or Remote</strong></p>
              {/* Download PDF CTA */}
              <div className="mb-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded btn-secondary text-slate-900 dark:text-slate-100 focus-visible:ring-offset-slate-50 dark:focus-visible:ring-offset-slate-900"
                >
              ...
              <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-slate-600 dark:text-slate-400 text-sm">
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50 dark:focus-visible:ring-offset-slate-900"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="p-2 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors w-10 flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50 dark:focus-visible:ring-offset-slate-900"
                  >
                  ...
                  <a
                    ...
                    className="p-2 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors w-10 flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50 dark:focus-visible:ring-offset-slate-900"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    className="p-2 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors w-10 flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50 dark:focus-visible:ring-offset-slate-900"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-7 flex flex-wrap justify-center gap-2">
                {[
                  ...
                  <span
                    key={tag}
                    className="px-3 py-1.5 rounded-full bg-white/70 dark:bg-slate-800/60 border border-slate-200/70 dark:border-slate-700/70 text-xs font-semibold text-slate-700 dark:text-slate-200"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <nav aria-label="Page sections" className="mb-10 flex flex-wrap gap-2 text-sm">
              {[
                ...
                <a
                  key={item.href}
                  href={item.href}
                  className="px-3 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200 hover:border-slate-300 dark:hover:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50 dark:focus-visible:ring-offset-slate-950"
                >
                  {item.label}
                </a>
              ))}
              ...
              <div className="resume-main">
                ...
                >
                  ...
                  <div className="space-y-4 text-slate-600 dark:text-slate-300 leading-relaxed text-base md:text-lg mt-6">
                    <p>
                      I’m a Senior Frontend Engineer with <strong className="text-blue-600 dark:text-blue-400">15+ years</strong> of experience building modern web products — from marketing sites to data-heavy enterprise platforms.
                ...
                <section className="section-divider">
                  ...
                  <div className="mt-6 p-5 border" style={{ borderColor: 'var(--border)' }}>
                    <p className="text-sm font-mono text-slate-500 dark:text-slate-400 mb-2">Principles.ts</p>
                    <div className="font-mono text-sm text-slate-800 dark:text-slate-200 leading-relaxed">
                      <div>
                        ...
                        <span className="text-blue-600 dark:text-blue-400">principles</span>{' '}
                        <span className="text-slate-400 dark:text-slate-500">=</span> {'{'}
                      </div>
                      <div className="pl-4">
                        <div>
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="section-title text-slate-800 dark:text-slate-200">Core Expertise</h2>
                  </div>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-5 border" style={{ borderColor: 'var(--border)' }}>
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">Frontend Development</h3>
                      </div>
                    ...
                    <div className="p-5 border" style={{ borderColor: 'var(--border)' }}>
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">Accessibility & Inclusive Design</h3>
                      </div>
                      <p className="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base">
                    ...
                    <div className="p-5 border" style={{ borderColor: 'var(--border)' }}>
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">CMS Integration</h3>
                      </div>
                      <p className="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base">
                    ...
                    <div className="p-5 border" style={{ borderColor: 'var(--border)' }}>
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">Quality & Best Practices</h3>
                      </div>
                      <p className="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base">
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="section-title text-slate-800 dark:text-slate-200">Selected Achievements</h2>
                  </div>
                  ...
                  <div className="grid gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        stack: 'React • i18n • RTL • Design System',
                        bullets: [
                      ...
                      >
                        <div className="flex flex-col md:items-start md:justify-between gap-2 mb-3">
                          ...
                          <p className="text-sm font-mono text-slate-500 dark:text-slate-400">{project.stack}</p>
                        </div>
                ...
                >
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <h2 className="section-title text-slate-800 dark:text-slate-200">Professional Experience</h2>
                  </div>
              ...
              <aside className="resume-side md:sticky md:top-24 self-start side-rail">
                ...
                >
                  ...
                  <div className="space-y-5">
                    <div>
                      <h3 className="font-semibold text-slate-700 dark:text-slate-300 mb-3 text-sm uppercase tracking-wide">Frontend</h3>
                      <div className="flex flex-wrap gap-2">
                        {['React.js', 'Next.js', 'TypeScript', 'JavaScript (ES6+)', 'Tailwind CSS', 'Bootstrap', 'Redux Toolkit', 'Context API', 'React Hook Form', 'HTML5', 'CSS3'].map((skill) => (
                          <span key={skill} className="chip text-slate-700 dark:text-slate-200">
                            {skill}
                          </span>
                        ))}
                      </div>
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-700 dark:text-slate-300 mb-3 text-sm uppercase tracking-wide">UI Engineering</h3>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-700 dark:text-slate-300 mb-3 text-sm uppercase tracking-wide">Integration</h3>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-700 dark:text-slate-300 mb-3 text-sm uppercase tracking-wide">Testing &amp; Quality</h3>
                      <div className="flex flex-wrap gap-2">
                ...
                <section className="section-divider">
                  <div className="flex items-center gap-2 mb-6">
                    <div className="flex items-center gap-2">
                      <span className="text-amber-500 dark:text-amber-400 font-mono text-sm">//</span>
                  ...
                  <div className="grid gap-3">
                    {[
                      ...
                      { k: 'Delivery', v: '15+ large-scale web platforms' },
                      ...
                      >
                        ...
                        <span className="text-sm font-mono text-slate-600 dark:text-slate-300">{item.v}</span>
                      </div>
                    ))}
                  </div>
                </section>
